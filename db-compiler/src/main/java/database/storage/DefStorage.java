...
public class DefStorage {
	...
	public static void updateIndex(final File table, final IColumnDef columnDef, final String value, final int index) {
		final Index objIndex = getIndex(table, columnDef);
		if (objIndex == null) {
			return;
		}

		objIndex.put(value, index);
